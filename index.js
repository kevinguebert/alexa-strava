...
exports.handler = function(event, context, callback) {
  ...
  alexa.registerHandlers(ActivityHandlers, ActivityStatsHandler);
  alexa.execute();
};

var ActivityHandlers = {
  "GetLastestActivity": function() {
...
var ActivityStatsHandler = {
  "RecentRunActivities": function() {
    this.emit(":tell", "create activity");
  },
  "YearRunActivities": function() {
    this.emit(":tell", "create activity");
  },
  "AllTimeRunActivities": function() {
    this.emit(":tell", "create activity");
  },
  "RecentSwimActivities": function() {
    this.emit(":tell", "create activity");
  },
  "YearSwimActivities": function() {
    this.emit(":tell", "create activity");
  },
  "AllTimeSwimActivities": function() {
    this.emit(":tell", "create activity");
  },
  "RecentRideActivities": function() {
    this.emit(":tell", "create activity");
  },
  "YearRideActivities": function() {
    this.emit(":tell", "create activity");
  },
  "AllTimeRideActivities": function() {
    this.emit(":tell", "create activity");
  },
}
